    ...
    <section ref={containerRef} className="relative pt-32 pb-32 overflow-hidden bg-blue-50/30 dark:bg-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-blue-900/70 dark:text-blue-200/60 max-w-lg mx-auto lg:mx-0 mb-10 leading-relaxed font-medium text-justify md:text-center lg:text-left">
          ...
          <div className="flex flex-col items-center lg:items-start gap-6">
            <div className="flex flex-col sm:flex-row flex-wrap gap-4 justify-center lg:justify-start">
              ...
              <div className="flex gap-3 justify-center">
                <button 
                  onClick={() => (window as any).triggerAppStoreMsg?.()}
                  className="p-4 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm hover:shadow-md transition-all active:scale-95 group/store"
                >
                  <Smartphone className="w-6 h-6 text-blue-600 dark:text-blue-400 group-hover/store:scale-110 transition-transform" />
                </button>
                <button className="p-4 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm hover:shadow-md transition-all active:scale-95 group/store">
                  <Zap className="w-6 h-6 text-orange-500 group-hover/store:scale-110 transition-transform" />
                </button>
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-3 gap-12">
          {features.map((f, i) => (
            ...
            >
              ...
              <p className="text-blue-900/70 dark:text-blue-300/70 leading-relaxed font-medium text-justify md:text-center lg:text-left">{f.desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
          ...
          {steps.map((s, i) => (
            ...
            >
              ...
              <div className="relative z-10 transition-all duration-300">
                ...
                <p className="text-slate-600 dark:text-blue-100/60 font-medium leading-relaxed text-base md:text-lg text-justify md:text-left">{s.desc}</p>
              </div>
            </motion.div>
          ))}
        </div>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="w-full text-center lg:text-left">
                ...
                <p className="text-xl md:text-2xl font-bold italic leading-relaxed mb-6 md:mb-8 text-slate-800 dark:text-blue-50 text-justify lg:text-left">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="text-lg text-blue-900/70 dark:text-blue-300/60 mb-12 font-medium leading-relaxed text-justify md:text-center lg:text-left">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6 group justify-center lg:justify-start">
                ...
                <div className="text-center lg:text-left">
                  ...
                  <p className="text-xl font-black text-blue-950 dark:text-white">Lomé, Togo - Quartier Adidogomé</p>
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-12 text-center md:text-left">
          <div className="md:col-span-2 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <p className="text-slate-500 dark:text-slate-400 max-w-sm mb-6 font-light text-justify md:text-left">Le laboratoire photo leader au Togo, réinventé pour le mobile. Livraison à domicile de vos plus beaux souvenirs.</p>
            ...
            >
              ...
              <div className="max-w-2xl relative z-10 text-center lg:text-left">
                ...
                <p className="text-blue-900/70 dark:text-blue-300/60 text-lg md:text-xl font-medium leading-relaxed text-justify md:text-center lg:text-left">
                  Nous acceptons toutes les solutions de paiement locales : <span className="font-bold underline decoration-orange-400">T-Money</span>, <span className="font-bold underline decoration-orange-400">Moov Money</span> et cartes bancaires. Sécurisé, rapide, flexible.
                </p>
              </div>
              
              <div className="flex flex-wrap gap-4 justify-center relative z-10">
                {['T-Money', 'Moov Money', 'VISA', 'Mastercard'].map((method, i) => (
                  <motion.div 
                    key={i}
                    whileHover={{ y: -5, scale: 1.05 }}
                    className="px-8 py-5 bg-white dark:bg-slate-800 rounded-2xl shadow-xl shadow-orange-200/20 dark:shadow-none border border-orange-100 dark:border-orange-900/30 text-xl font-black text-blue-950 dark:text-white"
                  >
                    {method}
                  </motion.div>
                ))}
               ...
               <div className="relative z-10 max-w-xl text-white text-center md:text-left">
                 ...
                 <div className="flex flex-col sm:flex-row flex-wrap gap-6 justify-center md:justify-start">
                    <button 
                      ...
                      className="bg-white text-blue-600 px-8 py-4 md:px-10 md:py-5 rounded-2xl flex items-center justify-center gap-4 hover:scale-105 active:scale-95 transition-all shadow-xl font-black"
                    >
                    ...
                    <button className="bg-blue-950/20 backdrop-blur-xl border-2 border-white/20 text-white px-8 py-4 md:px-10 md:py-5 rounded-2xl flex items-center justify-center gap-4 hover:scale-105 active:scale-95 transition-all shadow-xl font-black">
                       <Zap className="w-7 h-7 md:w-8 md:h-8 text-orange-400"/>
                       <div className="text-left">
                          <p className="text-[10px] uppercase opacity-60 leading-none mb-1 tracking-widest">Get it on</p>
                          <p className="text-lg md:text-xl font-black leading-none mt-1">Play Store</p>
                       </div>
                    </button>
                 </div>
               </div>
